...
namespace CodingFriends\FileVault\Tests;

use Illuminate\Support\Facades\Config;
use Illuminate\Support\Facades\Storage;
use Orchestra\Testbench\TestCase;
use CodingFriends\FileVault\Facades\FileVault;
use CodingFriends\FileVault\FileVaultServiceProvider;
...
class FileVaultTest extends TestCase
{
    ...
    {
        // Attention: Setting configs will not affect values
        // loaded in the FileVault init
        // because the Facade is initialized before this SetUp
        // here is called
        ...
        // Directly set the key because the config won't have any effect
        // at this point
        FileVault::key($this->generateRandomKey());
