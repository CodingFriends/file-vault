...
[![Build Status](https://img.shields.io/travis/soarecostin/file-vault/master.svg?style=flat-square)](https://travis-ci.org/coding-friends/file-vault)
[![Total Downloads](https://img.shields.io/packagist/dt/coding-friends/file-vault.svg?style=flat-square)](https://packagist.org/packages/soarecostin/file-vault)
...
```
php artisan vendor:publish --provider="CodingFriends\FileVault\FileVaultServiceProvider"
```
...
If you discover any security related issues, please email team@coding-friends.com instead of using the issue tracker.

## Credits

- [Gabriel Reimers](https://github.com/greimers)
